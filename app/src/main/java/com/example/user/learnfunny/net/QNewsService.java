package com.example.user.learnfunny.net;
...
import com.example.user.learnfunny.bean.RobotBean;
import com.example.user.learnfunny.bean.TodayOfHistoryBean;
import com.example.user.learnfunny.bean.TodayOfHistoryDetailBean;
...
public interface QNewsService {
     ...
     */
    // http://v.juhe.cn/toutiao/index?key=d78b502268f7456b79fbe7228cecdd46（作者本人）
    @GET("toutiao/index?key=f63c862349e58563b939c6557be9d356")
